...
`flutter_deck` 向けの絵本風ページと、移動方向に応じて物理動作を切り替えるページトランジションです。16:9のスライド全体を1枚の紙として扱い、スナップショットを三角形メッシュへ貼って変形します。進む時は前半を綴じ目寄りの中腹の隆起に使ってから、後半で加速して上下・紙端へめくりを伝えます。戻る時は旧ページを剥がさず、別の時間曲線で前ページを上層から影付きで被せ、減速しながら平らに戻します。ページが平らになった後は白紙を短く見せ、薄い下描き、中央下寄りから広がる水彩・インクの順で完成絵を描き出します。必要に応じて、紙をめくる音と鉛筆・筆で描く音も同期できます。
