...
class FlutterDeckSlide extends FlutterDeckSlideWidget {
  ...
  FlutterDeckSlide.bigFact({
    ...
    Key? key,
         ...
         builder: (context) {
           ...
           final bigFactSlideBuilder =
               configuration.templateOverrides.bigFactSlideBuilder;
  ...
  FlutterDeckSlide.blank({
    ...
    Key? key,
         ...
         builder: (context) {
           final configuration = context.flutterDeck.configuration;
           final blankSlideBuilder =
               configuration.templateOverrides.blankSlideBuilder;

           if (blankSlideBuilder != null) {
             return blankSlideBuilder(
               context,
               builder,
               backgroundBuilder,
               footerBuilder,
  ...
  FlutterDeckSlide.image({
    ...
    Key? key,
         ...
         builder: (context) {
           final configuration = context.flutterDeck.configuration;
           final imageSlideBuilder =
               configuration.templateOverrides.imageSlideBuilder;
  ...
  FlutterDeckSlide.quote({
    ...
    Key? key,
         ...
         builder: (context) {
           final configuration = context.flutterDeck.configuration;
           final quoteSlideBuilder =
               configuration.templateOverrides.quoteSlideBuilder;
  ...
  FlutterDeckSlide.split({
    ...
    Key? key,
         ...
         builder: (context) {
           final configuration = context.flutterDeck.configuration;
           final splitSlideBuilder =
               configuration.templateOverrides.splitSlideBuilder;
  ...
  FlutterDeckSlide.template({
    ...
    Key? key,
         ...
         builder: (context) {
           final configuration = context.flutterDeck.configuration;
           final templateSlideBuilder =
               configuration.templateOverrides.templateSlideBuilder;

           if (templateSlideBuilder != null) {
             return templateSlideBuilder(
               context,
               backgroundBuilder,
               contentBuilder,
               footerBuilder,
  ...
  FlutterDeckSlide.title({
    ...
    Key? key,
         ...
         builder: (context) {
           final configuration = context.flutterDeck.configuration;
           final titleSlideBuilder =
               configuration.templateOverrides.titleSlideBuilder;
  ...
  Widget build(BuildContext context) {
    ...
    var body = configuration.showProgress
        ? Stack(
            ...
            children: [child, configuration.progressIndicator],
          )
        : child;
