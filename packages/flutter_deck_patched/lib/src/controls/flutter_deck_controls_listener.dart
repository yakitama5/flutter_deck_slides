      ...
      widget = Actions(
        actions: <Type, Action<Intent>>{
          ...
          for (final shortcut in shortcuts.customShortcuts)
            shortcut.intentType: shortcut.action,
        },
        child: widget,
      );
      ...
      if (shortcuts.enabled) {
        widget = Shortcuts(
          shortcuts: <ShortcutActivator, Intent>{
            for (final activator in shortcuts.nextSlide)
              activator: const GoNextIntent(),
            for (final activator in shortcuts.previousSlide)
              activator: const GoPreviousIntent(),
            for (final activator in shortcuts.toggleMarker)
              activator: const ToggleMarkerIntent(),
            for (final activator in shortcuts.toggleNavigationDrawer)
              activator: const ToggleDrawerIntent(),
            for (final shortcut in shortcuts.customShortcuts)
              for (final activator in shortcut.activators)
                activator: shortcut.intent,
          },
          child: widget,
        );
      }
