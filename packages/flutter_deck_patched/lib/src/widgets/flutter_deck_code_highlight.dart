...
class FlutterDeckCodeHighlight extends StatefulWidget {
  ...
  @override
  State<FlutterDeckCodeHighlight> createState() =>
      _FlutterDeckCodeHighlightState();
}

class _FlutterDeckCodeHighlightState extends State<FlutterDeckCodeHighlight>
  ...
  void initState() {
    ...
    _transitionController = AnimationController(
      vsync: this,
      duration: widget.codeUpdateDuration,
    );
        ...
        child: ClipRect(
          child: Align(
            ...
            child: Opacity(
              opacity: factor,
              child: Text.rich(
                TextSpan(children: _buildStaticSpans(tokens, defaultTextStyle)),
              ),
            ),
          ),
        ),
  ...
  List<InlineSpan> _buildStaticSpans(
    List<_Token> tokens,
      ...
      if (tokens[i].style == currentStyle) {
        ...
        spans.add(
          TextSpan(
            ...
            style: currentStyle ?? defaultTextStyle,
          ),
        );
  ...
  Widget build(BuildContext context) {
    ...
    if (_highlighter == null) {
      ...
      final coloredCode = Text.rich(
        TextSpan(children: animatedSpans),
      ...
      if (widget.highlightedLines.isEmpty) {
        ...
        final fadedColoredCode = Text.rich(
          TextSpan(children: animatedSpans),
          style: defaultTextStyle,
        );
