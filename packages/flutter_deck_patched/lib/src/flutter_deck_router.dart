...
class FlutterDeckRouter extends ChangeNotifier {
  ...
  String? _getInitialRoute() {
    final initialRoute = slides
        .where((s) => s.configuration.initial)
        .singleOrNull
        ?.route;
  ...
  GoRouter build({
    ...
    return _router = GoRouter(
      ...
      routes: _isPresenterView
          ? [
              GoRoute(path: '/', redirect: (_, _) => _presenterViewRoute),
              GoRoute(
                path: _presenterViewRoute,
                builder: (_, _) => const PresenterView(),
              ),
            ]
          : [
              GoRoute(
                path: '/',
                redirect: (_, _) => initialRoute ?? slides.first.route,
              ),
                ...
                GoRoute(
                  ...
                  pageBuilder: (context, state) => CustomTransitionPage(
                    ...
                    reverseTransitionDuration:
                        ...
                        slide.configuration.transition.duration,
