...
class FlutterDeck {
  ...
  FlutterDeckSlideConfiguration get configuration =>
      _configuration is FlutterDeckSlideConfiguration
      ? _configuration
  ...
  T? maybeGetPlugin<T extends FlutterDeckPlugin>() =>
...
class FlutterDeckProvider extends InheritedWidget {
  ...
  static FlutterDeck of(BuildContext context) {
    final flutterDeckProvider = context
        .dependOnInheritedWidgetOfExactType<FlutterDeckProvider>();

    assert(
      flutterDeckProvider != null,
      'No FlutterDeckProvider found in context',
    );
  ...
  @override
  bool updateShouldNotify(FlutterDeckProvider oldWidget) =>
