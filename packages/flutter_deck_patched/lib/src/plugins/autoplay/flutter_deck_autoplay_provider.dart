...
class FlutterDeckAutoplayProvider extends InheritedWidget {
  ...
  const FlutterDeckAutoplayProvider({
  ...
  static FlutterDeckAutoplayNotifier of(BuildContext context) {
    final provider = context
        .dependOnInheritedWidgetOfExactType<FlutterDeckAutoplayProvider>();
  ...
  @override
  bool updateShouldNotify(FlutterDeckAutoplayProvider oldWidget) =>
