...
class FlutterDeckAutoplayPlugin extends FlutterDeckPlugin {
  ...
  Widget wrap(BuildContext context, Widget child) {
    return FlutterDeckAutoplayProvider(
      notifier: _autoplayNotifier,
      child: child,
    );
  }
  ...
  List<Widget> buildControls(
    ...
    FlutterDeckPluginMenuItemBuilder menuItemBuilder,
  ) {
    return [
      ListenableBuilder(
        ...
        builder: (context, _) => SubmenuButton(
          ...
          menuChildren: [
            menuItemBuilder(
              ...
              onPressed: _autoplayNotifier.isPlaying
                  ? _autoplayNotifier.pause
                  : _autoplayNotifier.play,
            ),
