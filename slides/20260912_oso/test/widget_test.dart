  ...
  test('selected story pages stay in numeric order', () {
    ...
    expect(
      ...
      orderedEquals(<String>[
        ...
        'assets/risukun_hitotsu_no_donguri/01_page01_pipl.png',
        'assets/risukun_hitotsu_no_donguri/02_page02.png',
        'assets/risukun_hitotsu_no_donguri/03_page03.png',
        'assets/risukun_hitotsu_no_donguri/04_page04_pipl.png',
        'assets/risukun_hitotsu_no_donguri/05_page05.png',
        'assets/risukun_hitotsu_no_donguri/06_page06.png',
        'assets/risukun_hitotsu_no_donguri/07_page07_pipl.png',
        'assets/risukun_hitotsu_no_donguri/08_page08_pipl.png',
        'assets/risukun_hitotsu_no_donguri/09_page09.png',
        'assets/risukun_hitotsu_no_donguri/10_page10_pipl.png',
        'assets/risukun_hitotsu_no_donguri/11_page11_ending_pipl.png',
      ]),
    );
  });
