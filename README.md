...
- `StorybookPageTurnTransitionBuilder`: 16:9のスライド全体を1枚の紙として扱い、40×16の三角形メッシュで紙面を曲げます。進む時は前半を綴じ目寄りの中腹の隆起に使い、その隆起が上下と紙端へ伝わった後、後半で加速してページを退けます。戻る時は旧ページを逆向きに剥がさず、別の時間曲線で前ページを上層から被せ、減速しながら平らに戻します
